      ...
      <el-header class="header">
        ...
        >
          <el-menu-item index="1" style="color: #5292d8; font-size: 20px"
            ><i class="el-icon-box"></i>人群队列数据特征抽取</el-menu-item
          >
           ...
           <el-menu-item index="/columnManage">
            ...
            >
             <el-menu-item index="/operationManage">
              ...
              操作日志</el-menu-item
            >
            <el-menu-item index="/featureExtract">
              <i class="el-icon-thumb"></i>
              单病种特征抽取</el-menu-item
            >
              <el-menu-item index="/multiefeature">
              <i class="el-icon-thumb"></i>
              多病种特征抽取</el-menu-item
            >

        ...
        <div class="table" v-if="dataShow.length != 0" v-loading="isload">
          <el-table
            ...
            :header-cell-style="{
             ...
             :default-sort = "{prop: 'dataShow.Weight', order: 'ascending'}"
            stripe
          >
            <el-table-column
...
export default {
  ...
  methods: {
        ...
        series: [
          {
            ...
            data: this.dataShow.map((item) => item.Weight+item.Weight2),
          },
        ],
      };
    ...
    dealNotice() {
      postRequest("featureExtraction/runPy2", this.list).then((response) => {
        ...
        this.dataAll = [...temp];
        this.dataAll.sort((a,b)=>b.Weight-a.Weight)
        this.dataShow = this.dataAll;
        this.countNum = this.dataAll.length;
        this.chooseK=this.dataAll.length;
        this.dataColumn = Object.keys(this.dataAll[0]);
        this.drawChart();
        this.show = false;
      });
    },
    ...
    changeShow(e) {
      this.dataShow = this.dataAll.slice(0, e);
      this.drawChart();
    },
  },
  mounted() {
